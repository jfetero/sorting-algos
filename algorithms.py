        ...
        for j in range(n - 1):
            if arr[j] > arr[j + 1]:
                ...
                drawList(
                    arr,
                    [
                        "red" if x == j or x == j + 1 else "sky blue"
    ...
    for i in range(1, len(arr)):
        ...
        while j > 0 and arr[j - 1] > arr[j]:
            ...
            drawList(
                arr,
                [
                    "red" if x == j or x == j - 1 else "blue" if x == i else "sky blue"
                    for x in range(len(arr))
                ],
            )
            time.sleep(speed)
...
def binary_insertion(arr, drawList, speed):
    ...
    for i in range(1, len(arr)):
        ...
        drawList(
            arr,
            [
                "gold" if x <= i else "blue" if x == i else "sky blue"
                for x in range(len(arr))
            ],
        )
        time.sleep(speed)
...
def merge(arr, left, mid, right, drawList=None, speed=None):
    ...
    drawList(
        arr,
        [
            "red" if x == idx else "green" if x >= left and x <= right else "sky blue"
            for x in range(len(arr))
        ],
    )
    time.sleep(speed)
...
def heap(arr, drawList, speed):
    ...
    for i in range(n - 1):
        ...
        drawList(
            ret + temp,
            ["green" if x < i else "red" if x == i else "sky blue" for x in range(n)],
        )
        time.sleep(speed)
...
def radix(arr, drawList=None, speed=None):
    ...
    for digit in range(num):
        ...
        n = len(arr)
        drawList(arr, ["sky blue" for _ in range(n)])
        time.sleep(speed)
        for i in range(n):
        ...
        for i in range(len(bucket)):
            ...
            drawList(arr + temp, ["sky blue" for _ in range(n)])
        time.sleep(speed)
